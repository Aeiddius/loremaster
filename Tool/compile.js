...
const componentsDir = `./${root}.lore/js/components`
...
fs.writeFileSync(`./${root}.lore/css/_imports.scss`, imports);
...
//
const composables = findFilesInDirectory(`./${root}.lore/js/composables`, '.js');
...
//
let app = fs.readFileSync(`./${root}.lore/js/app.js`, { encoding: 'utf8', flag: 'r' });
...
fs.writeFileSync(`./${root}.lore/js/index.js`, newIndex);
